...
def build_config(
    ...
    # Trigger recommendations Muon POG
    # 2022: https://twiki.cern.ch/twiki/bin/view/CMS/MuonHLT2022
    # 2023: https://twiki.cern.ch/twiki/bin/view/CMS/MuonHLT2023
    # 2024: https://twiki.cern.ch/twiki/bin/view/CMS/MuonHLT2024
    # recommended unprescaled single muon trigger for all years: HLT_IsoMu24_v*

    # Triggers used for embedding samples and also recommended double muon trigger
    # HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8_v
    common_singlemuon_trigger_parameters = [
        {
    ...
    configuration.add_config_parameters(
        ["mm"],
        {
            "singlemuon_trigger": EraModifier(
                {
                    "2024": common_singlemuon_trigger_parameters,
                    "2023preBPix": common_singlemuon_trigger_parameters,
                    "2023postBPix": common_singlemuon_trigger_parameters,
                    "2022preEE": common_singlemuon_trigger_parameters,
                    "2022postEE": common_singlemuon_trigger_parameters,
                    "2018": common_singlemuon_trigger_parameters,
                    "2017": common_singlemuon_trigger_parameters,
                    "2016postVFP": [
                        {
                            "flagname_1": "trg_IsoMu24_1",
                            "flagname_2": "trg_IsoMu24_2",
    ...
    # Run2 Trigger recommendations: https://twiki.cern.ch/twiki/bin/view/CMS/EgHLTRunIISummary
    # Run3 Trigger recommendations: https://twiki.cern.ch/twiki/bin/view/CMS/EgHLTRunIIISummary
    common_singleelectron_trigger_parameters = {
        "2024": [
            {
                "flagname_1": "trg_single_ele30_1",
                "flagname_2": "trg_single_ele30_2",
    ...
    configuration.add_config_parameters(
        ["ee"],
        {
            "singleelectron_trigger": EraModifier(
                {
                    "2024": common_singleelectron_trigger_parameters["2024"],
                    "2023preBPix": common_singleelectron_trigger_parameters["2023"],
                    "2023postBPix": common_singleelectron_trigger_parameters["2023"],
                    "2022preEE": common_singleelectron_trigger_parameters["2022"],
                    "2022postEE": common_singleelectron_trigger_parameters["2022"],
                    "2018": common_singleelectron_trigger_parameters["2018"],
                    "2017": common_singleelectron_trigger_parameters["2017"],
                    "2016postVFP": common_singleelectron_trigger_parameters["2016"],
                    "2016preVFP": common_singleelectron_trigger_parameters["2016"],
                    }),
        },
    )
            ...
            "recoil_systematics_file": EraModifier(
                {
                    ...
                    "2022preEE": "data/hleprare/DYandRecoilCorrlib/DY_pTll_recoil_corrections_2022preEE_v5.json.gz",
                    "2022postEE": "data/hleprare/DYandRecoilCorrlib/DY_pTll_recoil_corrections_2022postEE_v5.json.gz",
                    "2023preBPix": "data/hleprare/DYandRecoilCorrlib/DY_pTll_recoil_corrections_2023preBPix_v5.json.gz",
                    "2023postBPix": "data/hleprare/DYandRecoilCorrlib/DY_pTll_recoil_corrections_2023postBPix_v5.json.gz",
                    "2024": "data/hleprare/DYandRecoilCorrlib/DY_pTll_recoil_corrections_2024_v5.json.gz",
                }
            ),

...
namespace fakefactors {
    ...
    namespace sm {
        ...
        fakefactor_lt(
            ...
            auto df1 = df.Define(outputname, calc_fake_factor, {pt_2, njets, mt_1, decaymode_2, mass_2, eta_2, pt_1, deltar, deltar_1j1, pt_ttjj, met, m_vis, pt_tt});
        ...
        */
        ...
        fakefactor_tt(
            ...
            Logger::get("FakeFactor")
                ->debug("Setting up functions for fake factor evaluation with correctionlib");
            ...
            auto calc_fake_factor = [
                tau_idx, qcd_variation, fraction_variation, 
            ...
            auto df1 = df.Define(outputname, calc_fake_factor,
                {tau_pt_1, tau_pt_2, njets, m_vis, decaymode_1, decaymode_2, mass_1, mass_2, eta_1, eta_2, deltar, deltar_1j1, deltar_2j1, pt_ttjj, met, pt_tt});
            return df1;
        }

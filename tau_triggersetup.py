...
def add_diTauTriggerSetup(configuration: Configuration) -> Configuration:
    ...
    # shared by all Run 3 eras (2022preEE through 2026)
    singlemuon_trigger_run3_default = [
        {
    ...
    configuration.add_config_parameters(
        ["mt", "mm", "em"],
        {
            "singlemuon_trigger": EraModifier(
                ...
                default=singlemuon_trigger_run3_default,
            ),
        },
    )
            ...
            "mutau_cross_trigger": EraModifier(
                {
                    ...
                    **{
                        ...
                        for era in ["2016postVFP", "2016preVFP"]
                    },
                },
    ...
    configuration.add_config_parameters(
        ["et", "ee", "em"],
        {
            "singleelectron_trigger": EraModifier(
                ...
                default=[  # 2022preEE, 2022postEE, 2023preBPix, 2023postBPix, 2024, 2025, 2026
                    {
            ...
            "singleelectron_trigger_sf_file": EraModifier(
                {
                    ...
                    **{
                        era: "/cvmfs/cms-griddata.cern.ch/cat/metadata/EGM/Run3-24CDEReprocessingFGHIPrompt-Summer24-NanoAODv15/2025-12-15/electronHlt.json.gz"
                        for era in ["2024", "2025", "2026"]
                    },
                },
                default='""',  # Run 2 (unused)
            ...
            "singleelctron_trigger_era": EraModifier(
                {
                    ...
                    **{era: "2024Prompt" for era in ["2024", "2025", "2026"]},
                },
                default='""',  # Run 2 (unused)
            ),

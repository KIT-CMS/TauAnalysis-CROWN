...
TTGenerateDoubleTauTriggerSF_1 = Producer(
    ...
    # call='scalefactor::embedding::ditau_trigger_sf({df}, {input}, {output}, "{ditau_trigger_wp}",     "{emb_ditau_trigger_file}", "tauTriggerSF",             "{ditau_trigger_type}",         "{ditau_trigger_corrtype}", "{ditau_trigger_syst}")',  # TODO: Ask why change here?
...
Tau_2_VsJetTauID_lt_SF = ExtendedVectorProducer(
    ...
    # TODO: Check with changes regarding two differential WP
    input=[q.pt_2],

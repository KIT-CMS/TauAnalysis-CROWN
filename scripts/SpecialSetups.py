...
class ES_ID_SCHEME:
    def __init__(self, scheme: str = "dm_pt_binned"):
        ...
        if self.is_run3:
            ...
            raise ValueError(f"Unknown ES/ID scheme: {scheme}, known schemes are 'dm_binned', 'dm_pt_binned', and 'run3'")

    @property
    def pt_binning(self):
        return [""] if self.is_dm_binned or self.is_run3 else ["20to40", "40toInf"]

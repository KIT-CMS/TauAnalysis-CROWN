...
Electron_IDWP90 = NanoAODQuantity("Electron_mvaNoIso_WP90")
Electron_IDWP80 = NanoAODQuantity("Electron_mvaNoIso_WP80")
...
Jet_eta = NanoAODQuantity()
Jet_chHEF = NanoAODQuantity()
Jet_neHEF = NanoAODQuantity()
Jet_chEmEF = NanoAODQuantity()
Jet_neEmEF = NanoAODQuantity()
Jet_muEF = NanoAODQuantity()
#Jet_nConstituents = NanoAODQuantity()
Jet_chMultiplicity = NanoAODQuantity()
Jet_neMultiplicity = NanoAODQuantity()

#Jet_jetId = NanoAODQuantity()
...
PFMET_phi = NanoAODQuantity()
PFMET_pt = NanoAODQuantity()
PFMET_sumEt = NanoAODQuantity()
